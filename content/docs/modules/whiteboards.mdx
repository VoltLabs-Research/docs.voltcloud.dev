...
## Task: Create a collaborative whiteboard

1. Click the **Create** button from the whiteboard listing view.
2. Enter a **name** for the new whiteboard.
3. Open the canvas and start drawing using the toolbar tools.
4. Invite a teammate by sharing the whiteboard link or adding them to the board.
5. Verify that your teammate's live cursor appears on the canvas.

**Expected outcome:** Both participants can draw on the same canvas simultaneously, with live cursors visible in real time.
