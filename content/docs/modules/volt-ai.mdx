...
A single conversation persists across tasks and can invoke the assistant's tools to inspect and manage Docker containers and to manage its own conversations.

![Conversation Example](/assets/modules/team/ai-integration/volt-ai-conversation-example-2.png)

## Available Tools

Volt AI has access to **12 tools** organized across 2 categories: container management and AI conversation management. Tools cover read operations and workspace mutations such as creating, updating, and deleting Docker containers. Mutating tools require explicit approval before execution.
