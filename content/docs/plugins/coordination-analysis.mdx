...
- [Structure Identification](/docs/plugins/structure-identification) — identify crystal structures alongside coordination analysis
- [Cluster Analysis](/docs/plugins/cluster-analysis) — group atoms by connectivity
