...
This file is surfaced in VOLT as the **Coordination Model** exposure and exported as a `.glb` scene.

### `{outputBase}_rdf_chart.msgpack`
...
This file is surfaced in VOLT as the **RDF Chart** exposure and exported as a `chart-png` image (x-axis: `r`, y-axis: `g(r)`).
