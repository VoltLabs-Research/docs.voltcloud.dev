...
You should build the plugin workflow in the UI from [https://app.voltcloud.dev/dashboard/plugins/list](https://app.voltcloud.dev/dashboard/plugins/list).
