...
- [OpenDXA](/docs/plugins/open-dxa) — dislocation analysis using structure identification
- [Grain Segmentation](/docs/plugins/grain-segmentation) — grain detection using PTM
- [Centrosymmetry Parameter](/docs/plugins/centrosymmetry-parameter) — complementary defect detection
