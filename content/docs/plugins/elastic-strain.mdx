...
- [Atomic Strain](/docs/plugins/atomic-strain) — Green-Lagrangian strain tensors
- [Displacements Analysis](/docs/plugins/displacements-analysis) — displacement fields
- [Structure Identification](/docs/plugins/structure-identification) — required for crystal matching
