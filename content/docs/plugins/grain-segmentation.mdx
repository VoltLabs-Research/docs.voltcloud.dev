...
- [OpenDXA](/docs/plugins/open-dxa) — dislocation analysis in polycrystals
- [Structure Identification](/docs/plugins/structure-identification) — identify crystal structures within grains
